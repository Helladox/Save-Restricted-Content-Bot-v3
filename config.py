...
BOT_TOKEN = os.getenv("BOT_TOKEN", "7850997210:AAEJXbH29JZdDC-oJ9dGE3dkkCtPTxMHLwk")
...
MASTER_KEY = os.getenv("MASTER_KEY", "4e1c150e809fb4a47ea006225f63488c") # for session encryption
IV_KEY = os.getenv("IV_KEY", "4ac6ca552c69") # for decryption
